...
exports.default = function (client, stz) {
    _model2.default.auth.findOne({ username: client.jid.user }, function (err, user) {
        var expireditems = _ltx2.default.parse("<iq to='" + stz.attrs.from + "' from='" + stz.attrs.to + "' id='" + stz.attrs.id + "' type='result'>" + "<query xmlns='urn:cryonline:k01'>" + "<get_expired_items/>" + "</query>" + "</iq>");
        client.send(expireditems);
    });
};
//# sourceMappingURL=expireditems.js.map