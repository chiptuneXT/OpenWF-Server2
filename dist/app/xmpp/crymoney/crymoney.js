...
exports.default = function (client, stz) {
    _model2.default.profile.findOne({ username: client.jid.user }, function (err, user) {
        var crymoney = _ltx2.default.parse("<iq to='" + stz.attrs.from + "' from='" + stz.attrs.to + "' id='" + stz.attrs.id + "' type='result'>" + "<query xmlns='urn:cryonline:k01'>" + "<get_cry_money cry_money='" + user.cry_money + "' />" + "</query>" + "</iq>");
        client.send(crymoney);
    });
};
//# sourceMappingURL=crymoney.js.map